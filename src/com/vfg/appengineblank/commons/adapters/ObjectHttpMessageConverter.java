package com.vfg.appengineblank.commons.adapters;
...
public class ObjectHttpMessageConverter implements HttpMessageConverter<Object> {
	...
	public boolean canRead(Class clazz, MediaType mediaType) {
		return objectMapper.canSerialize(clazz)
				&& formHttpMessageConverter.canRead(MultiValueMap.class,
						mediaType);
	}
	...
	public Object read(Class clazz, HttpInputMessage inputMessage)
		...
		Map<String, String> input = formHttpMessageConverter.read(
				LINKED_MULTI_VALUE_MAP_CLASS, inputMessage).toSingleValueMap();
